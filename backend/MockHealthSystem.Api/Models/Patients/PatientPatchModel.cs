...
/// <summary>
/// Partial update model for patient (PATCH).
/// </summary>
public class PatientPatchModel
{
    public int? PrimarySiteId { get; set; }
    public PatientPhoneEditModel? Phone1 { get; set; }
    public PatientPhoneEditModel? Phone2 { get; set; }
    public PatientPhoneEditModel? Phone3 { get; set; }
    public PatientPhoneEditModel? Phone4 { get; set; }
